use super::types::*;
use crate::Lib;
use e_utils::{CResult, auto_any_res_c};
...
impl HcMvsCoreSdk {
  ...
  /// ```
  pub unsafe extern "C" fn get_int_value_ex(&self, key: *const c_char, intvalue: *mut MvCcIntValueEx) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, strKey: *const c_char, pstIntValue: *mut MvCcIntValueEx) -> c_int> =
        auto_any_res_c!(self.lib().get(b"MV_CC_GetIntValueEx\0"));
    CResult::Ok(func(self.handle, key, intvalue))
  }

  /// # ch:获取Float属性值     | en:Get Float value
  /// ```
  /// 参数
  /// handle [IN] 设备句柄
  /// strKey [IN] 属性键值,如获取宽度信息则为"Gain"
  /// pstFloatValue [IN][OUT] 返回给调用者有关设备属性结构体指针
  ///
  /// 备注
  /// 连接设备之后调用该接口可以获取float类型的指定节点的值,具体可以查看客户端属性描述
  /// ```
  pub unsafe extern "C" fn get_float_value(&self, key: *const c_char, float_value: *mut MvCcFloatValue) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, strKey: *const c_char, pstFloatValue: *mut MvCcFloatValue) -> c_int> =
        auto_any_res_c!(self.lib().get(b"MV_CC_GetFloatValue\0"));
    CResult::Ok(func(self.handle, key, float_value))
  }
  ...
  /// ```
  pub unsafe extern "C" fn set_float_value(&self, key: *const c_char, value: c_float) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, strKey: *const c_char, fValue: c_float) -> c_int> =
        auto_any_res_c!(self.lib().get(b"MV_CC_SetFloatValue\0"));
  ...
  ///  • 该接口不支持CameraLink设备。
  /// ```
  pub unsafe extern "C" fn get_image_buffer(&self, frame: *mut MvFrameOut, msec: c_uint) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, pstFrame: *mut MvFrameOut, nMsec: c_uint) -> c_int> =
  ...
  pub unsafe extern "C" fn free_image_buffer(&self, frame: *mut MvFrameOut) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, pstFrame: *mut MvFrameOut) -> c_int> =
  ...
  pub unsafe extern "C" fn open_params_gui(&self) -> CResult<c_int> {
    ...
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void) -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_OpenParamsGUI\0"));
  ...
  pub unsafe extern "C" fn get_sdk_version(&self) -> CResult<c_uint> {
    ...
    let func: Symbol<'_, unsafe extern "C" fn() -> c_uint> = auto_any_res_c!(self.lib().get(b"MV_CC_GetSDKVersion\0"));
    CResult::Ok(func())
  }
  ...
  pub unsafe extern "C" fn enumrate_tls(&self) -> CResult<c_int> {
    ...
    let func: Symbol<'_, unsafe extern "C" fn() -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_EnumerateTls\0"));
    CResult::Ok(func())
  }
  ...
  /// ```
  pub unsafe extern "C" fn enumrate_devices(&self, layer_type: MvEnumDeviceLayerType, out_dev_list: *mut MvCcDeviceInfoList) -> CResult<c_int> {
    // # C原型:int __stdcall MV_CC_EnumDevicesEx2(unsigned int nTLayerType, MV_CC_DEVICE_INFO_LIST* pstDevList)
    let func: Symbol<'_, unsafe extern "C" fn(nTLayerType: c_uint, pstDevList: *mut MvCcDeviceInfoList) -> c_int> =
  ...
  pub unsafe extern "C" fn enumrate_devices_ex2(
    ...
    CResult::Ok(func(layer_type as c_uint, out_dev_list, manufacturer_mame, sort_method))
  }
  ...
  /// ```
  pub unsafe extern "C" fn is_device_accessible(&self, dev_info: &MvCcDeviceInfo, access_mode: MvAccessMode) -> CResult<bool> {
    // # C原型：bool __stdcall MV_CC_IsDeviceAccessible(IN MV_CC_DEVICE_INFO* pstDevInfo, IN unsigned int nAccessMode);
    let func: Symbol<'_, unsafe extern "C" fn(pstDevInfo: *const MvCcDeviceInfo, nAccessMode: c_uint) -> bool> =
  ...
  pub unsafe extern "C" fn create_handle(&mut self, dev_info: &MvCcDeviceInfo) -> CResult<c_int> {
    ...
    let func: Symbol<'_, unsafe extern "C" fn(handle: *mut *mut c_void, pstDevInfo: *const MvCcDeviceInfo) -> c_int> =
  ...
  /// 根据输入的设备信息，创建库内部必须的资源和初始化内部模块。通过该接口创建句柄，调用SDK接口，会默认生成SDK日志文件，如果不需要生成日志文件，可以通过 MV_CC_CreateHandleWithoutLog() 创建句柄。
  /// ```
  pub unsafe extern "C" fn create_handle_without_log(&mut self, dev_info: &MvCcDeviceInfo) -> CResult<c_int> {
    // # C原型:int MV_CC_CreateHandle(void ** handle, MV_CC_DEVICE_INFO* pstDevInfo)
    let func: Symbol<'_, unsafe extern "C" fn(handle: *mut *mut c_void, pstDevInfo: *const MvCcDeviceInfo) -> c_int> =
  ...
  pub unsafe extern "C" fn destroy_handle(&self) -> CResult<c_int> {
    ...
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void) -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_DestroyHandle\0"));
    CResult::Ok(func(self.handle))
  }
  ...
  /// ```
  pub unsafe extern "C" fn open_device(&self, access_mode: MvAccessMode, switchover_key: c_ushort) -> CResult<c_int> {
    //# C原型:int MV_CC_OpenDevice(void* handle, unsigned int nAccessMode, unsigned short nSwitchoverKey)
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, nAccessMode: c_uint, nSwitchoverKey: c_ushort) -> c_int> =
  ...
  pub unsafe extern "C" fn close_device(&self) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void) -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_CloseDevice\0"));
    CResult::Ok(func(self.handle))
  }
  ...
  pub unsafe extern "C" fn is_device_connected(&self) -> CResult<bool> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void) -> bool> = auto_any_res_c!(self.lib().get(b"MV_CC_IsDeviceConnected\0"));
    CResult::Ok(func(self.handle))
  }
  ...
  /// ```
  pub unsafe extern "C" fn register_image_callback_ex(&self, cb_output_callback: CbOutputCallback, user: *const c_void) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, cbOutput: CbOutputCallback, pUser: *const c_void) -> c_int> =
  ...
  /// 示例ChunkData.cpp, Grab_Callback.cpp , 以及 LensShadingCorrection.cpp.
  /// ```
  pub unsafe extern "C" fn register_image_callback_for_rgb(&self, cb_output_callback: CbOutputCallback, user: *const c_void) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, cbOutput: CbOutputCallback, pUser: *const c_void) -> c_int> =
  ...
  /// 示例ChunkData.cpp, Grab_Callback.cpp , 以及 LensShadingCorrection.cpp.
  /// ```
  pub unsafe extern "C" fn register_image_callback_for_bgr(&self, cb_output_callback: CbOutputCallback, user: *const c_void) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, cbOutput: CbOutputCallback, pUser: *const c_void) -> c_int> =
  ...
  pub unsafe extern "C" fn start_grabbing(&self) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void) -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_StartGrabbing\0"));
    CResult::Ok(func(self.handle))
  }
  ...
  pub unsafe extern "C" fn stop_grabbing(&self) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void) -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_StopGrabbing\0"));
    CResult::Ok(func(self.handle))
  }
  ...
  pub unsafe extern "C" fn get_optimal_packet_size(&self) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void) -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_GetOptimalPacketSize\0"));
    CResult::Ok(func(self.handle))
  }
  /// # ch:设置Integer型属性值  | en:
  /// ```
  ...
  /// ```
  pub unsafe extern "C" fn set_int_value(&self, key: *const c_char, value: c_uint) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, strKey: *const c_char, nValue: c_uint) -> c_int> =
  ...
  /// ```
  pub unsafe extern "C" fn get_bool_value(&self, key: *const c_char, value: *mut bool) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, strKey: *const c_char, pbValue: *mut bool) -> c_int> =
  ...
  ///
  /// 备注
  /// 连接设备之后调用该接口可以设置Boolean类型的指定节点的值。
  /// ```
  pub unsafe extern "C" fn set_bool_value(&self, key: *const c_char, value: bool) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, strKey: *const c_char, bValue: bool) -> c_int> =
        auto_any_res_c!(self.lib().get(b"MV_CC_SetBoolValue\0"));
    CResult::Ok(func(self.handle, key, value))
  }
  /// # ch:设置Enum型属性值    | en:
  /// ```
  ...
  /// ```
  pub unsafe extern "C" fn set_enum_value(&self, key: *const c_char, value: c_uint) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, strKey: *const c_char, pbValue: c_uint) -> c_int> =
  ...
  pub unsafe extern "C" fn set_sdk_log_path(&self, path: *const c_char) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(strSDKLogPath: *const c_char) -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_SetSDKLogPath\0"));
  ...
  pub unsafe extern "C" fn display(&self, hwnd: *mut c_void) -> CResult<c_int> {
    ...
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, hWnd: *mut c_void) -> c_int> = auto_any_res_c!(self.lib().get(b"MV_CC_Display\0"));
  ...
  /// ```
  pub unsafe extern "C" fn display_one_frame(&self, display_info: &MvDisplayFrameInfo) -> CResult<c_int> {
    // MV_CAMCTRL_API int __stdcall MV_CC_DisplayOneFrame  ( IN void *  handle,  IN MV_DISPLAY_FRAME_INFO *  pstDisplayInfo  )
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, pSaveParam: *const MvDisplayFrameInfo) -> c_int> =
  ...
  /// ```
  pub unsafe extern "C" fn save_image_to_file(&self, file_param: *mut MvSaveImgToFileParam) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, pstSaveFileParam: *mut MvSaveImgToFileParam) -> c_int> =
  ...
  ///  • MV_CC_SaveImageEx2() 比 MV_CC_SaveImageEx() 增加参数handle，为了保证与其他接口的统一。
  /// ```
  pub unsafe extern "C" fn save_image_ex2(&self, save_param: *mut MvSaveImageParamEx) -> CResult<c_int> {
    // MV_CAMCTRL_API int __stdcall MV_CC_DisplayOneFrame  ( IN void *  handle,  IN MV_DISPLAY_FRAME_INFO *  pstDisplayInfo  )
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, pSaveParam: *mut MvSaveImageParamEx) -> c_int> =
  ...
  pub unsafe extern "C" fn get_one_frame_timeout(
    ...
    let func: Symbol<
      '_,
      unsafe extern "C" fn(handle: *const c_void, pData: *mut c_uchar, nDataSize: c_uint, pstFrameInfo: *mut MvFrameOutInfoEx, nMsec: c_uint) -> c_int,
  ...
  /// ```
  pub unsafe extern "C" fn set_exposure_auto_mode(&self, value: MvCamExposureMode) -> CResult<c_int> {
    let func: Symbol<'_, unsafe extern "C" fn(handle: *const c_void, pValue: *const c_uint) -> c_int> =
